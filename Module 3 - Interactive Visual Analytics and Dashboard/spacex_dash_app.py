...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Success Chart for All Sites')
        return fig
    else:
...
def update_graph(site_dropdown, slider_ranger):
    filtered_df_1 = spacex_df[(slider_ranger[0] < spacex_df['Payload Mass (kg)']) & (spacex_df['Payload Mass (kg)']< slider_ranger[1])]
